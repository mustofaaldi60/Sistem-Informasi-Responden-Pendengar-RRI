...
<section class="content">
    <div class="card">
        <div class="card-body">
            <form action="/acara/{{ $acaras->id }}" method="POST">
                @csrf
                @method('put')
                <div class="row">
                    <div class="col-md-6">
          ...
          is-invalid
      @enderror" id="nama" placeholder="Example: Aldi" required autofocus value="{{ old('nama',$acaras->nama) }}" name="nama">
                            @error('nama')
      ...
      @enderror" id="penyiar" placeholder="Example: Putri" required value="{{ old('penyiar',$acaras->penyiar) }}" name="penyiar">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" name="hari" id="hari" value="{{ old('hari',$acaras->hari) }}" class="form-control @error('hari')
        is-invalid
    @enderror" required>
                            @error('hari')
                            <span class="invalid-feedback" role="alert">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="time" name="jam" id="jam" value="{{ old('jam',$acaras->jam) }}" class="form-control @error('jam')
        is-invalid
    @enderror" required>
                            @error('jam')
                            <span class="invalid-feedback" role="alert">

...
<head>
    ...
    <!-- Favicons -->
    <link href="{{ asset('Tempo/assets/img/favicon.png') }}" rel="icon">
    <link href="{{ asset('Tempo/assets/img/apple-touch-icon.png') }}" rel="apple-touch-icon">
    ...
    <link href="{{ asset('Tempo/assets/vendor/remixicon/remixicon.cs') }}s" rel="stylesheet">
